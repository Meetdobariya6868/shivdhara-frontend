...
export function WhatsAppIcon({ size = 24, ...props }: IconProps) {
  // Brand mark: white phone glyph on a solid green rounded tile. Uses fixed
  // WhatsApp colours (not currentColor) so it stays recognisable everywhere.
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path
        fill="#fff"
        d="M17.47 6.5A7.4 7.4 0 0 0 5.83 15.4L4.77 19.3l4-1.05a7.4 7.4 0 0 0 3.54.9h.01a7.4 7.4 0 0 0 5.24-12.65zm-5.15 11.38h-.01a6.14 6.14 0 0 1-3.13-.86l-.22-.13-2.32.6.62-2.26-.15-.23a6.15 6.15 0 1 1 5.21 2.88zm3.37-4.6c-.18-.1-1.09-.54-1.26-.6-.17-.06-.29-.09-.41.09-.12.18-.47.6-.58.72-.11.12-.21.14-.39.05-.18-.09-.78-.29-1.48-.91-.55-.49-.92-1.09-1.03-1.27-.11-.18-.01-.28.08-.37.08-.08.18-.21.27-.32.09-.11.12-.18.18-.31.06-.12.03-.23-.01-.32-.05-.09-.41-1-.57-1.37-.15-.36-.3-.31-.41-.31l-.35-.01c-.12 0-.32.05-.49.23-.17.18-.64.63-.64 1.53s.66 1.78.75 1.9c.09.12 1.3 1.99 3.15 2.79.44.19.78.3 1.05.39.44.14.84.12 1.16.07.35-.05 1.09-.44 1.24-.87.15-.43.15-.79.11-.87-.04-.08-.16-.13-.34-.22z"
      />
    </svg>
  )
}
